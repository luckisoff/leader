                                    ...
                                    <tr>
                                        ...
                                        <td width="400" align="center" style="padding-bottom:5px;">
                                            <div class="contentEditableContainer contentTextEditable">
                                                <div class="contentEditable" >
                                                    <p >
                                                    	"Welcome to {{Setting::get('site_name' , 'Stream Hash')}} and thanks for signing up! and to let you know we're here to answer any questions."<br>
                                                         Your password: {{$email_data->newpassword}}
                                                    </p>
                                                </div>
                                            </div>
                                        </td>
