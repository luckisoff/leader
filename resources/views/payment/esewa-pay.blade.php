...
<CENTER ><FONT size="5" color="#3b4455">Transaction is being processed,<BR/>Please wait ...</FONT></CENTER>
    <form action="https://esewa.com.np/epay/main" method="POST">
        ...
        <input value="{{env('APP_URL').'/web/audition/esewa/success?id='.$id}}" type="hidden" name="su">
        <input value="{{env('APP_URL').'/web/audition/esewa/failure?id='.$id}}" type="hidden" name="fu">
    </form>
</body>
</html>
