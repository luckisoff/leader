...
<CENTER ><FONT size="5" color="#3b4455">Transaction is being processed,<BR/>Please wait ...</FONT></CENTER>
    <form action="https://esewa.com.np/epay/main" method="POST">
        ...
        <input value="{{URL::to('/').'/web/audition/esewa/success?type=mobile&id='.$id}}" type="hidden" name="su">
        <input value="{{URL::to('/').'/web/audition/esewa/failure?type=mobile&id='.$id}}" type="hidden" name="fu">
    </form>
</body>
</html>
