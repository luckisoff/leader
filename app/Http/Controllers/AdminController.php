...
class AdminController extends Controller
{
    ...
    public function users() {
        ...
        $leaderboard=LeaderBoard::orderBy('point','desc')->first();
...
//videoupload area
    ...
    public function add_video_process(Request $request) {
        ...
        $video_validator = Validator::make( $request->all(), array(
                    'video'     => 'required|mimes:mkv,mp4,qt,webm',
    ...
    public function ajax(Request $request)
    {
        ...
        if(!empty($users))
        {
            foreach ($users as $key=>$user)
            {
                ...
                $nestedData['point'] =$user->leaderBoard->first()?'Rs '.number_format($user->leaderBoard->first()['point'],2,'.',''):'No data';
